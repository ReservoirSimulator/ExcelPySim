...
def DxInterface(sht,gridDimn,backColor):
...
def DyInterface(sht,gridDimn,backColor):
...
def DzInterface(sht,gridDimn,backColor):
...
def PoroInterface(sht,gridDimn,backColor):
...
def PermxInterface(sht,gridDimn,backColor):
...
def PermyInterface(sht,gridDimn,backColor):
...
def PermzInterface(sht,gridDimn,backColor):
...
def GridStep0():
    ...
    gridDimension = readGeneralInfo(sht)

    DxInterface(sht,gridDimension,greenColor)

    DyInterface(sht,gridDimension,greenColor)
        
    DzInterface(sht,gridDimension,greenColor)

    PoroInterface(sht,gridDimension,greenColor)

    PermxInterface(sht,gridDimension,greenColor)
    
    PermyInterface(sht,gridDimension,greenColor)

    PermzInterface(sht,gridDimension,greenColor)
